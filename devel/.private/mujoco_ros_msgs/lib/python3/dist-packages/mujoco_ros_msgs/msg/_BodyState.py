...
"""autogenerated by genpy from mujoco_ros_msgs/BodyState.msg. Do not edit."""
import codecs
import sys
...
class BodyState(genpy.Message):
  _md5sum = "d600e8997a5f40618fda48064d38b421"
  _type = "mujoco_ros_msgs/BodyState"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """string name                 # this can either be the body name or name of a geom belongig to the body.
...
float64 y
float64 z"""
  __slots__ = ['name','pose','twist','mass']
  _slot_types = ['string','geometry_msgs/PoseStamped','geometry_msgs/TwistStamped','float32']
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_6df().pack(_x.twist.twist.linear.x, _x.twist.twist.linear.y, _x.twist.twist.linear.z, _x.twist.twist.angular.x, _x.twist.twist.angular.y, _x.twist.twist.angular.z, _x.mass))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.twist.twist.linear.x, _x.twist.twist.linear.y, _x.twist.twist.linear.z, _x.twist.twist.angular.x, _x.twist.twist.angular.y, _x.twist.twist.angular.z, _x.mass,) = _get_struct_6df().unpack(str[start:end])
      return self
