...
class StepActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new StepFeedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = StepFeedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new StepActionFeedback(null);
    ...
    data.feedback = StepFeedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new StepActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = StepFeedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new StepFeedback()
    }
...
module.exports = StepActionFeedback;
