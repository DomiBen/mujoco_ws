...
class StepActionResult {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = StepResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new StepActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = StepResult.Resolve(msg.result)
    }
    else {
      resolved.result = new StepResult()
    }
...
module.exports = StepActionResult;
